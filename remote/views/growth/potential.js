...
export default class RemoteGrowthPotential extends HTMLElement {
  constructor() {
    super();
    ...
    template.innerHTML = /* template */ `
      ...
      <adc-hbox>
        <adc-textarea
          helper="How will future contributions grow in scope, complexity, and business impact?"
          label="Description"
          light
...
window.customElements.define( 'arm-growth-potential', RemoteGrowthPotential );

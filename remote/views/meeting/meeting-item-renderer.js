...
export default class RemoteMeetingItemRenderer extends HTMLElement {
  constructor() {
    super();
  ...
  _render() {
    if( this._data !== null ) {
      ...
      this.$subject.innerText = this._data.subject;
    }
  }
...
window.customElements.define( 'arm-meeting-item-renderer', RemoteMeetingItemRenderer );
